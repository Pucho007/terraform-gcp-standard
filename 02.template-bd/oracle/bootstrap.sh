...
gcloud services enable \
  storage.googleapis.com bigquery.googleapis.com workflows.googleapis.com \
...
echo "¡Entorno listo! Ya puedes ejecutar 'terraform init', 'terraform plan' y 'terraform apply'."