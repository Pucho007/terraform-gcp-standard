...
# 4. Subimos el archivo maestro de tablas a ingestar
resource "google_storage_bucket_object" "config_tablas" {
  name   = "tablas_origen.json" 
  bucket = google_storage_bucket.config.name
  source = "../src/parametros/tablas_origen.json" 
}